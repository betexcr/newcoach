...
const es: TranslationKeys = {
  ...
  demo: {
    ...
    coachDescription: "Panel, clientes, constructor de entrenamientos, programas, biblioteca de ejercicios y mensajería",
    clientView: "Vista Cliente",
    clientDescription: "Entrenamiento del día, calendario, progreso, logros, hábitos, nutrición y mensajería",

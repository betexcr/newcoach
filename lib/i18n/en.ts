const en = {
  ...
  demo: {
    ...
    coachDescription: "Dashboard, clients, workout builder, programs, exercise library, and messaging",
    clientView: "Client View",
    clientDescription: "Today's workout, calendar, progress, milestones, habits, nutrition, and messaging",

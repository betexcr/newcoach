const en = {
  ...
  settings: {
    ...
    profileSlug: "Profile URL",
    profileSlugHint: "newcoach.vercel.app/coach/your-slug",
    bio: "Bio",
    specialties: "Specialties",
    specialtiesHint: "Comma-separated (e.g. Strength, HIIT, Yoga)",
  ...
  library: {
    ...
    deleteExerciseConfirm: "Delete this exercise? This cannot be undone.",
    ...
    thumbnailUrlLabel: "Thumbnail URL (optional)",
    ...
    mealPlan: "Meal Plan",
    assignDocument: "Assign to Client",
  },
  pickExercise: {
    title: "Add Exercise",
    searchPlaceholder: "Search exercises...",
  ...
  milestones: {
    ...
    firstSteps: {
      ...
      flavor: "Every legend starts somewhere. You just took that first step!",
      howTo: "Complete any scheduled workout and mark it as done.",
    },
    gettingStarted: {
      title: "Getting Started",
      description: "Complete 5 workouts",
      flavor: "Five down, a lifetime to go. You're building a habit!",
      howTo: "Complete 5 workouts total — any type counts.",
    },
    dedicated: {
      title: "Dedicated",
      description: "Complete 10 workouts",
      flavor: "Double digits! Your consistency is showing.",
      howTo: "Complete 10 workouts total to prove your dedication.",
    },
    committed: {
      title: "Committed",
      description: "Complete 25 workouts",
      flavor: "Quarter-century of sessions. This isn't a phase — it's a lifestyle.",
      howTo: "Complete 25 workouts total. Keep showing up!",
    },
    unstoppable: {
      title: "Unstoppable",
      description: "Complete 50 workouts",
      flavor: "Half a hundred! Nothing can slow you down now.",
      howTo: "Complete 50 workouts total. You're a force of nature.",
    },
    centuryClub: {
      title: "Century Club",
      description: "Complete 100 workouts",
      flavor: "Welcome to the triple-digit club. Elite status, earned.",
      howTo: "Complete 100 workouts total — a true milestone.",
    },
    weekWarrior: {
      title: "Week Warrior",
      description: "7-day workout streak",
      flavor: "Seven days, zero excuses. That's warrior mentality.",
      howTo: "Work out every day for 7 consecutive days.",
    },
    monthOfIron: {
      title: "Month of Iron",
      description: "30-day workout streak",
      flavor: "A full month of iron discipline. Forged in the gym.",
      howTo: "Maintain a workout streak for 30 consecutive days.",
    },
    heavyHitter: {
      title: "Heavy Hitter",
      description: "Lift 100+ lbs in a single set",
      flavor: "Triple digits on the bar! You're moving serious weight.",
      howTo: "Log a set with 100 lbs or more on any exercise.",
    },
    beastMode: {
      title: "Beast Mode",
      description: "Lift 200+ lbs in a single set",
      flavor: "200+ lbs?! The plates are trembling. Absolute beast.",
      howTo: "Log a set with 200 lbs or more on any exercise.",
    },
    eliteLifter: {
      title: "Elite Lifter",
      description: "Lift 300+ lbs in a single set",
      flavor: "300+ club. You don't just lift — you dominate.",
      howTo: "Log a set with 300 lbs or more on any exercise.",
    },
  },
  nutrition: {
    title: "Nutrition",
  ...
  publicProfile: {
    ...
    poweredBy: "Powered by NewCoach",
    closeVideo: "Close video",
    tapToRecord: "Tap to record",
    micPermissionDenied: "Microphone access is required to record voice messages. Please enable it in your device settings.",
  },
  demo: {
    ...
    workoutNames: {
      ...
      lowerBodyPower: "Lower Body Power",
      pushDay: "Push Day",
      pullDay: "Pull Day",
      activeRecovery: "Active Recovery",
      upperStrength: "Upper Strength",
      lowerPower: "Lower Power",
      pushFocus: "Push Focus",
      pullFocus: "Pull Focus",
      strengthFoundations: "Strength Foundations 4-Week",
      fullBodyBlast: "Full Body Blast",
      strengthFoundationsDesc: "Progressive overload program for intermediate lifters",
      weeklyMotivation: "Weekly Motivation",
    },
    chatMessages: {
      msg1: "Hey Jordan! Welcome aboard. I've set up your first week of training.",
      msg2: "Thanks Coach! Just checked the plan — looks great. Should I use a belt for squats?",
      msg3: "Great question. Train without a belt until you're comfortable with 1.5x bodyweight. Focus on bracing your core.",
      msg4: "Got it, will do. Crushed the upper body session yesterday!",
      msg6: "I saw the log — nice work! Today is lower body, take your time warming up.",
      convLast1: "I saw the log — nice work! Today is lower body, take your time warming up.",
      convLast2: "Thanks for the new program! Starting Monday.",
      convLast3: "Crushing it this week team! Keep pushing through your workouts.",
    },
    ...
    limitedFeature: "This feature is available in the full app. Sign up to unlock!",
    documentsSection: "Documents",
    introDocuments: "Upload PDFs, spreadsheets, and images. Assign documents to individual clients — they'll see them in their Documents tab.",
    introClientDocuments: "Documents your coach has shared with you. Tap to open or download.",
    voiceMessageDemo: "Voice message (demo)",
    recordingDemo: "Tap to record a voice message — your coach will hear it instantly.",
    publicProfileSection: "Public Profile",
    introPublicProfile: "This is how your public profile looks to potential clients. Share the link to attract new athletes.",
    webhooksSection: "Webhook Integrations",
    newConversation: "New Conversation",
    inviteBanner: "You have a pending coach invitation",
    acceptInvite: "Accept",
